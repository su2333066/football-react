...
app.get("/profile", async (req, res) => {
  ...
  const query = `SELECT place, link, memo, LEVEL, DATE_FORMAT(matchtime, '%Y-%m-%d') AS matchday, DATE_FORMAT(matchtime, '%H:%i') AS matchhour FROM matching WHERE match_user_seq = '${loginUser.seq}'`;
